...
#if COREMARK_HAS_NORETURN
#define COREMARK_RETURN_VAL
#define COREMARK_RETURN_TYPE void
#else
#define COREMARK_RETURN_VAL  0
#define COREMARK_RETURN_TYPE int
#endif

/* Prototype of the coremark function */
#if COREMARK_HAS_NOARGC
COREMARK_RETURN_TYPE
coremark(void);
#else
COREMARK_RETURN_TYPE
